...
from yash_shell.yash.functions import execute_commands, ls, clear
from yash_shell.checker import checker, yaml_directory
...
def shell():
    ...
    env = os.path.expanduser(os.path.expandvars(HOME_DIR + "/.config/yash/Themes"))
    sys.path.append(env)
    checker()
